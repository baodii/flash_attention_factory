...
#include "paged_attention_kernel_fp8_loop.hpp"
...
inline auto launch_paged_attn_fp8_loop(float *max_logits, float *exp_sums, T *out,
                                   T *tem_out, T *query, uint8_t *key_cache,
                                   uint8_t *value_cache, float *alibi_slopes, T *sinks,
                                   float *debug_out, U *block_tables,
                                   U *context_lens, uint32_t max_num_partitions,
                                   float sm_scale, float fp8_scale, uint32_t num_seqs,
  ...
  using kernel = paged_attention_loop_kernel_fp8<policy, T, U, fp8_format_, arch_tag>;
    ...
    cgh.parallel_for<kernel>(
        nd_range, [=](sycl::nd_item<3> item) SYCL_ESIMD_KERNEL {
          ...
          typename kernel::arguments_t args(
              reinterpret_cast<T *>(out), reinterpret_cast<float *>(debug_out),
...
inline auto dispatch_paged_attention_fp8_loop(
    ...
    float *alibi_slopes, T *sinks, float *debug_out, U *block_tables, U *context_lens,
  ...
  if (head_size == 128 && block_size == 64) {
    ...
    case 1:
      return launch_paged_attn_fp8_loop<128, 64, 1, T, U, fp8_format_, arch_tag>(
    ...
    case 2:
      return launch_paged_attn_fp8_loop<128, 64, 2, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 3:
      return launch_paged_attn_fp8_loop<128, 64, 3, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 4:
      return launch_paged_attn_fp8_loop<128, 64, 4, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 5:
      return launch_paged_attn_fp8_loop<128, 64, 5, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 6:
      return launch_paged_attn_fp8_loop<128, 64, 6, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 7:
      return launch_paged_attn_fp8_loop<128, 64, 7, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 8:
      return launch_paged_attn_fp8_loop<128, 64, 8, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    ...
    switch (num_queries_per_tokens) {
    case 1:
      return launch_paged_attn_fp8_loop<64, 64, 1, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 2:
      return launch_paged_attn_fp8_loop<64, 64, 2, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 3:
      return launch_paged_attn_fp8_loop<64, 64, 3, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 4:
      return launch_paged_attn_fp8_loop<64, 64, 4, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 5:
      return launch_paged_attn_fp8_loop<64, 64, 5, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 6:
      return launch_paged_attn_fp8_loop<64, 64, 6, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 7:
      return launch_paged_attn_fp8_loop<64, 64, 7, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
    case 8:
      return launch_paged_attn_fp8_loop<64, 64, 8, T, U, fp8_format_, arch_tag>(
          max_logits, exp_sums, out, tem_out, query, key_cache, value_cache,
          alibi_slopes, sinks, debug_out, block_tables, context_lens,
          max_num_partitions, sm_scale, fp8_scale, num_seqs, num_heads, num_kv_heads,
          max_blocks_per_seq, softcap);
