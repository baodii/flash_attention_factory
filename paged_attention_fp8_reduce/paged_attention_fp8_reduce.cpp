...
#include "launch_kernels_fp8_reduce.h"
...
std::vector<float> paged_attention_fp8(
  ...
  return dispatch_paged_attention_fp8<T, U, fp8_t, arch_tag>(
...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("run", &paged_attention_fp8, "Paged Attention");
}
